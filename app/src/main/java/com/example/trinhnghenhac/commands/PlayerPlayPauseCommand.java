...
public class PlayerPlayPauseCommand extends PlayerCommandBase {
    public PlayerPlayPauseCommand(MediaPlayerService service, ExoPlayer player, ExecutorService executor, ListIterator<Playable> playableIter) {
